...
./configure --target-os=linux  \
            ...
            --sysroot=$PLATFORM \
            --extra-cflags="-I$PREFIX/include -I$EXTERN_SSL  -I$EXTERN_OPUS -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 $OPTIMIZE_CFLAGS " \
            --disable-shared \
            --disable-debug \
            --enable-static \
            --extra-ldflags="-Wl,-rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib -L$PREFIX/lib -L$EXTREN_SSL_LIB -nostdlib -lc -lm -ldl -llog -lopus" \
            --enable-gpl \
            --enable-nonfree \
            --enable-parsers \
            --disable-encoders \
...
$PREBUILT/bin/arm-linux-androideabi-ld -rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib  -soname libffmpeg.so -shared -nostdlib  -z noexecstack -Bsymbolic --whole-archive --no-undefined -o $PREFIX/libffmpeg.so libavcodec/libavcodec.a libavformat/libavformat.a libavutil/libavutil.a libswresample/libswresample.a libavdevice/libavdevice.a $EXTREN_SSL_LIB/libssl.so $EXTREN_SSL_LIB/libcrypto.so $EXTREN_OPUS_LIB/libopus.so -lc -lm -lz -ldl -llog --dynamic-linker=/system/bin/linker ../../prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/lib/gcc/arm-eabi/4.6.x-google/libgcc.a
